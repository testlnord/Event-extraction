...
CREATE TABLE IF NOT EXISTS entity_sets (
    entity_uid REFERENCES entities NOT NULL,
    f_entity_uid REFERENCES f_entities NOT NULL
};

CREATE TABLE IF NOT EXISTS relation_sets (
    relation_uid REFERENCES relations NOT NULL,
    f_relation_uid REFERENCES f_relations NOT NULL
};
